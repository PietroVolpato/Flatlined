...
for subject=1:length(SUBJ)
    ...
    %%
    SUBJ_DYN_TH=[0.75 0.70 0.70 0.80 0.75 0.80 nan 0.75];
    ...
    xline(SUBJ_DYN_TH(subject),'k')
    legend({'fract of decisions','fract of correct dec','dynamical model accuracy','sing samp acc','chosen threshold'},'Location','south')
    ...
    save(fullfile('results','ACC',subjdir, 'OFFLINE_DYNACC.mat'),'T_ACC_DYNOFFLINEmatrix','timeForDecisionDYNOFFLINE')
    pause
end
